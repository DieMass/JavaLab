...
import die.mass.rabbitmqsimple.consumers.SecondListener;
...
public class RabbitmqsimpleApplication {
	...
	public static void main(String[] args) {
		var context = SpringApplication.run(RabbitmqsimpleApplication.class, args);
	...
	public FanoutExchange fanout() {
		return new FanoutExchange("passports", false, true);
	}
