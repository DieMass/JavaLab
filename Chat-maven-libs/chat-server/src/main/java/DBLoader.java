...
public class DBLoader {
    ...
    public void saveUser(String name, String password) {
        userRepository.save(new User(null, name, (long) password.hashCode()));
    }

    public boolean findUser(String name, Long password) {
        return userRepository.contains(name, password);
    }
